...
class LRMTrainer(Trainer):
    ...
    def train_endo_gaussian(self):
        ...
        from EndoGaussian.train import training
        from argparse import ArgumentParser
        
        # Create empty parser (will be populated in train.py)
        parser = ArgumentParser(description="Training script parameters")
        
        # Call training with config path - all parameter handling is done in train.py
    ...
    def train(self):
        ...
        with tqdm(
            ...
            profiler = torch.profiler.profile(
                ...
                schedule=torch.profiler.schedule(wait=10, warmup=10, active=100),
