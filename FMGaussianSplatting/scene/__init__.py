import os
from FMGaussianSplatting.utils.system_utils import searchForMaxIteration
from FMGaussianSplatting.scene.dataset_readers import sceneLoadTypeCallbacks
from FMGaussianSplatting.scene.gaussian_model import GaussianModel
from FMGaussianSplatting.arguments import ModelParams
...
class Scene:
    ...
    def __init__(self, args : ModelParams, gaussians : GaussianModel, load_iteration=None, shuffle=True, resolution_scales=[1.0], load_coarse=False):
        ...
        if self.loaded_iter:
            ...
            if args.extra_mark == 'endonerf' or args.extra_mark == 'stereomis':
